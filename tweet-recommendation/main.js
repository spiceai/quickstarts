...
console.log("Tweet-recommendation v0.1!");
console.log("");
...
/**
 * Fetches a recommendation from the Spice.ai endpoint for the tweet-recommendation pod
 *
 * @returns Spice.ai Recommendation
 */
const fetchRecommendation = async () => {
  console.log("Fetching tweet activity recommendation...");
  const response = await fetch(
    "http://localhost:8000/api/v0.1/pods/tweet-recommendation/recommendation"
  ).catch((e) => {});
